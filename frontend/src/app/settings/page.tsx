...
import { Settings, User, Building2, Key, LogOut, Plus } from "lucide-react";
      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            <div className="flex justify-between"><span>Backend URL</span><span className="text-muted-foreground">{process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000/api/v1"}</span></div>

...
```
HostWise_0.8.3_universal.dmg      # macOS
HostWise_0.8.3_x64-setup.exe      # Windows (NSIS)
hostwise_0.8.3_amd64.deb          # Linux (Debian / Ubuntu)
hostwise-0.8.3-1.x86_64.rpm       # Linux (Fedora / RHEL)
HostWise_0.8.3_amd64.AppImage     # Linux (AppImage)
```
